...
export const CROUCH_SPEED_MULT = 1.2; // how much slower the player moves when crouching
...
export const GALLOP_SPEED_MULT = 2; // how much faster the player moves when galloping
